...
// final _imageProviderProvider =
//     Provider.family<ImageProvider, _ImageProviderConstruct>((ref, construct) {
...
//   ImageProvider assetProvider(String path) {
//     return appRef.read(
//       _imageProviderProvider(
//         _ImageProviderConstruct(
//           path,
//           MediaSourceTypes.asset,
//           this,
//         ),
//       ),
//     );
...
//   ImageProvider fileProvider(File file) {
//     return appRef.read(
//       _imageProviderProvider(
//         _ImageProviderConstruct(
//           file,
//           MediaSourceTypes.file,
//           this,
//         ),
//       ),
//     );
...
//   ImageProvider memoryProvider(List<int> bytes) {
//     return appRef.read(
//       _imageProviderProvider(
//         _ImageProviderConstruct(
//           bytes,
//           MediaSourceTypes.memory,
//           this,
//         ),
//       ),
//     );
// // return getImageProvider(
// //   data: bytes,
// //   source: MediaSourceTypes.memory,
// //   builder: this,
// // );
//   }

//   ImageProvider base64Provider(String base64) {
//     return appRef.read(
//       _imageProviderProvider(
//         _ImageProviderConstruct(
//           base64,
//           MediaSourceTypes.base64,
//           this,
//         ),
//       ),
//     );
// // return getImageProvider(
// //   data: base64,
// //   source: MediaSourceTypes.base64,
// //   builder: this,
// // );
//   }
...
//   Widget memory(List<int> bytes) {
//     return _ImageRenderer(
//       imageBuilder: this,
//       type: MediaSourceTypes.memory,
//       data: bytes,
//       excludeFromSemantics: excludeFromSemantics,
//       colorBlendMode: colorBlendMode,
//     );
...
//   Widget base64(String data) {
//     return _ImageRenderer(
//       imageBuilder: this,
//       type: MediaSourceTypes.base64,
//       data: data,
//       excludeFromSemantics: excludeFromSemantics,
//       colorBlendMode: colorBlendMode,
//     );
