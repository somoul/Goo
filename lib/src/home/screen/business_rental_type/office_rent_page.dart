...
class OfficeRentPage extends StatelessWidget {
  const OfficeRentPage({Key? key, this.appBarTitle = "ដាក់ជួលការិយាល័យ"})
      : super(key: key);
  static const String routeName = "/office_rent_page";
